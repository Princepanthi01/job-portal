...
export const AppContextProvider = (props) => {
    ...
    const fetchUserData = async () => {
        try {
            ...
            const {data} = await axios (backendUrl + '/api/users/user',
    ...
    const value = {
        ...
        companyData , setCompanyData , companyToken, setCompanyToken, backendUrl, userData , setUserData , userApplications , setUserApplications,
